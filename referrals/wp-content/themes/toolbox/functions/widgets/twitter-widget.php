...
/* Twitter widget */
/*---------------------------------------------------------------------------------*/
class Digi_Twitter extends WP_Widget {

   function Digi_Twitter() {
	   $widget_ops = array('description' => 'Add your Twitter feed to your sidebar with this widget.' );
       parent::WP_Widget(false, __('Digi - Twitter Stream'),$widget_ops);      
   }
   ...
   function widget($args, $instance) {  
	...
	?>
        ...
        <?php echo Digi_twitter_script($unique_id,$username,$limit); //Javascript output function ?>	 
