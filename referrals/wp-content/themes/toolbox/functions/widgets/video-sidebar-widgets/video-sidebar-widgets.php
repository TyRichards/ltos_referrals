...
class VideoSidebarWidget extends WP_Widget {
		...
		function VideoSidebarWidget() {
				...
				$this->WP_Widget( 'videosidebar', __('Digi - Video Widget', 'videosidebar'), $widget_ops, $control_ops );
...
$this->WP_Widget( 'randomvideosidebar', __('Digi - Random Video Widget', 'randomvideosidebar'), $widget_ops, $control_ops );
}
...
function dd_vsw_tinymce_plugin($plugin_array) {
   $plugin_array['vsw'] = get_bloginfo('template_url').'/functions/widgets/video-sidebar-widgets/editor_plugin.js';
   return $plugin_array;
}
