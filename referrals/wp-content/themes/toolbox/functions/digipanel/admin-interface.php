...
$functions_path = OF_FILEPATH . '/functions/digipanel/';
...
<div class="wrap" id="of_container">
  ...
  <form action="" enctype="multipart/form-data" id="ofform">
    ...
    <img style="display:none" src="<?php echo bloginfo('stylesheet_directory'); ?>/functions/digipanel/images/loading-bottom.gif" class="ajax-loading-img ajax-loading-img-bottom" alt="Working..." />
...
function of_load_only() {
	...
	wp_register_script('jquery-input-mask', OF_DIRECTORY.'/functions/digipanel/js/jquery.maskedinput-1.2.2.js', array( 'jquery' ));
	wp_enqueue_script('jquery-input-mask');
	
	function of_admin_head() { 
			
		echo '<link rel="stylesheet" type="text/css" href="'.OF_DIRECTORY.'/functions/digipanel/admin-style.css" media="screen" />';
		
		 // COLOR Picker ?>
<link rel="stylesheet" media="screen" type="text/css" href="<?php echo OF_DIRECTORY; ?>/functions/digipanel/css/colorpicker.css" />
<script type="text/javascript" src="<?php echo OF_DIRECTORY; ?>/functions/digipanel/js/colorpicker.js"></script>
...
<?php
		//AJAX Upload
		?>
<script type="text/javascript" src="<?php echo OF_DIRECTORY; ?>/functions/digipanel/js/ajaxupload.js"></script>
