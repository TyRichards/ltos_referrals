         ...
         function shortcode($atts)
         {
			...
			$out .= "<div>\r";
			  ...
			  if (!$user_ID):
			      ...
			      $out .= "<p class=\"chk\"><a href=\"". bloginfo('url') . "/wp-login.php?action=lostpassword\" title=\"Get a new password sent to you\">Lost your password?</a></p><br />";
				  $out .= "<p class=\"chk\"><a href=\"". bloginfo('url') . "/wp-signup.php\" title=\"Sign up for a new account\">Create a new account</a></p><br />";
			      $out .= "</form>";
			...
			$out .= "&nbsp;<a href=\"". $tmp_user_url . "wp-admin/\" title=\"". _e('Dashboard') ."\"><strong>". _e('Your dashboard'). "</a></strong>";

			$out .= "<br />";
			$out .= "&nbsp;<a href=\"". $tmp_user_url . "wp-admin/post-new.php\" title=\"". _e('Posting Area') ."\">". _e('Write a post')."</a>";
			$out .= "<br />";
			$out .= "&nbsp;<a href=\"". $tmp_user_url ."wp-admin/users.php?page=edit_user_avatar\" title=\"". _e('Edit your avatar') ."\">". _e('Upload new avatar') ."</a>";
			$out .= "<br /><br />";
