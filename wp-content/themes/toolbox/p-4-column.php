...
<?php
	...
	$postimage = vt_resize($thumb, '', 201, 150, true );
?>
<li class="box column-<?php echo $count; ?> <?php if($count  % 4 == 0) echo 'last' ?>">
...
<?php else : ?>
	...
	<a class="gallery-zoom preload" rel="prettyPhoto[pp_gal]" href="<?php $thumbnail_id=get_the_post_thumbnail($post->ID); preg_match ('/src="(.*)" class/',$thumbnail_id,$link); echo $link[1]; ?>"><img src="<?php echo $postimage[url]; ?>" width="<?php echo $postimage[width]; ?>" height="<?php echo $postimage[height]; ?>" /><span></span></a> 
    <?php endif; ?>   
    <h2><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
    <?php global $more; $more = FALSE; ?><?php the_content( __('<span>View project</span>', 'percivale')); ?>
</li>
<?php if($count  % 4 == 0) echo '<div class="wide-clear"></div>' ?>
<?php $count++;  ?>
<?php 
endwhile;  } endif;
?>
