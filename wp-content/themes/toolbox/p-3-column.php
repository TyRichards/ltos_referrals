...
<?php
	...
	$postimage = vt_resize($thumb, '', 286, 160, true );
?>
<li class="box column-<?php echo $count; ?> <?php if($count  % 3 == 0) echo 'last' ?>">
...
<?php if($count  % 3 == 0) echo '<div class="wide-clear"></div>' ?>
<?php $count++;  ?>
<?php 
endwhile;  } endif;
?>
