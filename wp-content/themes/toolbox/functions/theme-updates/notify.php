 ...
 **                                                                                                                       **
 ** 2. Open up notifier.xml, change line 3 to reflect the latest version number of your theme,                            **
 **    make necessary updates to the changelog.                                                                           **
 **                                                                                                                       **
 ** 3. Upload this to a spot on your server.                                                                              **
 **                                                                                                                       **
 ** 4. Open up update_notifier.php > find line 57 > point this to the notifier.xml file                                   **
 **    you uploaded in step 3                                                                                             **
 **                                                                                                                       **
 ** That's it, if the user has a version of your theme that is lower than whats on line 3 of the notifier.xml             **
 ** they'll get the notification in their admin.                                                                          **
 **                                                                                                                       ** 
 ** NOTE : This compares the version number from line 3 in notifier.xml to the version number in style.css of your theme. **
 **        So make sure these are up to date.                                                                             **
 **                                                                                                                       **
 **                                                                                                                       **
 ***************************************************************************************************************************
 ***************************************************************************************************************************
...
function update_notifier() { 
	...
	<div class="wrap">
        ...
        <img style="float: left; margin: 0 20px 50px 0;" src="<?php echo get_bloginfo( 'template_url' ) . '/screenshot.png'; ?>" />
        
        <div id="instructions" style="max-width: 800px;">
            <h3>Update Download and Instructions</h3>
            <p><strong>Please note:</strong> make a <strong>backup</strong> of the Theme inside your WordPress installation folder <strong>/wp-content/themes/<?php echo strtolower($theme_data['Name']); ?>/</strong>. A backup is strongly advised especially if you made changes to the theme.</p>
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://digitonik.com/theme-update-notify/toolbox/notifier.xml';
	
	$db_cache_field = 'digitonik-notifier-cache';
	$db_cache_field_last_updated = 'digitonik-notifier-last-updated';
